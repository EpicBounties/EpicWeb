...
window.addEventListener("load", function(event) {
  ...
  // anchor link to section Acerca De La Plataforma
  const slideToAcercaPlataforma = document.querySelector('#sectionAcercaDeLaPlataforma');
  $('.nav-link-como-funciona').on('click', function() {
    locoScroll.scrollTo(slider)
  });

  // anchor link to section Beneficios
  const slideToBeneficios = document.querySelector('#sectionBeneficios');
  $('.nav-link-beneficios').on('click', function() {
      locoScroll.scrollTo(slider)
  });
